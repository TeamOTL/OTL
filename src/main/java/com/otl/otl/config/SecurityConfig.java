    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/","/api/**","/studyRoom_yu","api/studyRoomManager/**","/api/studyRoomManager/**","/api/studyRoomManager","/board","dashBoard", "/login","/oauth2/**","error/**","/main", "/index", "/home","/static/**","/img/**","/scss/**","/vendor/**","/icon/**", "/resources/**", "/templates/**", "/css/**", "/js/**", "/images/**","/oauth2/authorization/kakao").permitAll()  // 지정된 경로들은 누구나 접근 가능
